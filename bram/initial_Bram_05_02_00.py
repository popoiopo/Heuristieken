...
time_frames = ['9.00-11.00', '11.00-13.00', '13.00-15.00', '15.00-17.00', '17.00-19.00']
...
#	punten_verd_week = bonus_distribution(rooster)
	punten_verd_week = 1
...
for i in range(0,200):
	...
	rooster = make_random_timetable(rooster, group_student_database, days_in_week, time_frames, lokalen_info)
