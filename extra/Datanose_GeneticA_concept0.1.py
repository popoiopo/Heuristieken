...
population_size_per_generation = 50*best_scores_maxsize #laat populatie groeien tot deze size voordat selectie wordt toegepast
			...
			for classroom in table[day][timeslot].keys():
				if bool(table[day][timeslot][classroom]):
					...
					if subject in check_all_subjects:
						...
						x += 1
	if (len(check_all_subjects) + x) < int(124/4):
