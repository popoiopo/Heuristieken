...
best_scores = {}
best_scores_maxsize = 1
#best_scores = {-1001: 'lala', -100: 'haha', -10000: 'hihi'}
best_scores = {-1001: 'lala'}
for i in range(0,30):
	...
	best_scores = take_best_scores(best_scores, score_total, time_table, i, best_scores_maxsize)
	time_table.clear()
...
keys = best_scores.keys()
for key in keys:
	print(key)
	random_subject = deepcopy(delete_random_subject(best_scores[key]))
	print(random_subject, 'in main')
	best_scores[key] = scheduling(random_subject, best_scores[key], group_student_database, days_in_week, time_frames, classroom_info)
