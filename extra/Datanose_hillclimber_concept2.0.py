...
best_scores_maxsize = 20 #onthoud n aantal beste random gemaakte roosters
n_random_tests = 20 #genereert n aantal random roosters waarvan de beste (n=best_scores_maxsize) worden onthouden
n_mutaties = 2001 #probeert n aantal mutaties en onthoud als een rooster betere score heeft
n_changes_in_mutation = 5 #n aantal veranderingen voordat rooster wordt geevalueerd
...
###			print(random_subject, 'wordt random geroosterd, zeer waarschijnlijk niet op de zelfde plek')
		...
		if k % print_every_n_mutations == 0:
			if key == 'a':
