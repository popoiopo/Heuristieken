...
##---------------Functions -----------------------------------------------------##
#Creates a temporary empty timetable
def rooster(week, tijdslots, lokalen_info):
	rooster = {}
	for dag in week:
		rooster[dag] = {}
...
def subject_student_database(all_subject_names, student_info, info_student):
...
def ordening_en_invulling(all_subject_names, vakinfo):
...
rooster(week, tijdslots, lokalen_info)
subject_student_database(all_subject_names, student_info, info_student)
group_student_database = ordening_en_invulling(all_subject_names, vakinfo)
for subject in list(group_student_database.keys()):
	roosteren(subject, rooster, group_student_database)
