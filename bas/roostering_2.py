...
#Check welke studenten vak volgen. Sla studenten nr op in dict
...
#Maak een leeg rooster van dicts in volgorde dag->lokaal->tijdslot
...
def duplicate_student(rooster, tijdsslot):
	print check
