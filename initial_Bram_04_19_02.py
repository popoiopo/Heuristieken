...
for check in sorted(subject_student_number.values(), reverse=True):
	subject = number_student_subject[check]
	#Hoe vaak wordt vak gegeven in de week?
	times_week = int(aantalcollegesinweek(vak_info, number_student_subject[check]))
